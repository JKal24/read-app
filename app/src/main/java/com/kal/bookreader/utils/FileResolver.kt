...
class FileResolver @Inject constructor(
    ...
    private val String.removeLocalUriPrefix: String get() = removePrefix("local://")
    private val String.addLocalUriPrefix: String get() = "local://${this}"
    private val String.isContentUri: Boolean get() = startsWith("content://")
...
fun rememberResolvedBookImagePath(bookUrl: String, imagePath: String): Any {
    ...
    val appFileResolver = remember(context) { FileResolver(context) }
